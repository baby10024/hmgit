...
<head>  
            ...
            $("a[title]").click(function(){  
                ...
                if($("#tt").tabs("exists", text)) {  
                    ...
                    $("#tt").tabs("add",{  
                        title:text,  
                        closable:true,  
                        content:'<iframe src="send_user_query.action" frameborder="0" width="100%" height="100%" />'  
    ...
    <body class="easyui-layout">  
        <div data-options="region:'north',title:'欢迎来到鲜果后台管理',split:true" style="height:100px;"></div>     
        <div data-options="region:'west',title:'系统操作',split:true" style="width:200px;">  
            ...
            <div id="menu" class="easyui-accordion" data-options="fit:true">     
                <div title="基本操作" data-options="iconCls:'icon-save'">     
                    <ul>  
                        <li><a href="#" title="send_user_query.action">用户管理</a>  
                        <li><a href="#">商品管理</a>  
                    </ul>  
                </div>     
